pipeline {
  ...
  environment {
        ...
        SONARQUBE_TAGS = "biodiversity.europa.eu,demo-biodiversity.eea.europa.eu,demo-www.eea.europa.eu,www.eea.europa.eu-en,forest.eea.europa.eu,industry.eea.europa.eu,insitu.copernicus.eu,demo-ied.eea.europa.eu"
    }
